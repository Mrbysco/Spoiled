...
//
//		registration.addRecipes(SpoilCategory.TYPE, getVatRecipes(spoilCategory).stream().map(RecipeHolder::value).toList());
//	}
//
//
//	public List<RecipeHolder<SpoilRecipe>> getVatRecipes(IRecipeCategory<SpoilRecipe> spoilCategory) {
