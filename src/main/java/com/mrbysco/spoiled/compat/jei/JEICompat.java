...
public class JEICompat implements IModPlugin {
	...
	private static List<SpoilRecipe> getValidHandledRecipes(RecipeManager recipeManager, SpoiledValidator validator) {
		return recipeManager.getAllRecipesFor(SpoiledRecipes.SPOIL_RECIPE_TYPE.get()).stream().filter(r -> validator.isRecipeValid(r) && validator.isRecipeHandled(r)).toList();
	}
}
