...
public class SpoilCategory implements IRecipeCategory<SpoilRecipe> {
	...
	@Override
	public void draw(SpoilRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
		...
		guiGraphics.text(font, component, 0, 0, 8, false);
		poseStack.popMatrix();
